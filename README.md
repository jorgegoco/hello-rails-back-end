...
**Hello Rails Back-End App** is a project about building an API endpoint using Rails which generates random greetings.
...
```sh
  cd desired-folder
  git https://github.com/jorgegoco/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/jorgegoco/hello-rails-back-end/issues).
